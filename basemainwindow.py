...
# Form implementation generated from reading ui file '/tmp/mainwindowYv5530.ui'
#
...
class Ui_BaseMainWindow(object):
    def setupUi(self, BaseMainWindow):
        ...
        self.thisGuessTable.setCornerButtonEnabled(True)
        ...
        self.colorsTable.setMinimumSize(QtCore.QSize(276, 46))
        self.colorsTable.setMaximumSize(QtCore.QSize(276, 46))
        ...
        self.colorsTable.horizontalHeader().setDefaultSectionSize(46)
        ...
        self.colorsTable.verticalHeader().setDefaultSectionSize(46)
